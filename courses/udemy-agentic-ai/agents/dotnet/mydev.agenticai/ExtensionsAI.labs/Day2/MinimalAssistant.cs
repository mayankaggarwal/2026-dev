...
namespace ExtensionsAI.labs.Day2
{
    internal class MinimalAssistant : RunnerBase
    {
        private readonly ILogger<MinimalAssistant> _logger;
        public MinimalAssistant(AppConfigurations appConfigurations
            , ILogger<MinimalAssistant> logger)
        ...
        {
            OpenAIClient openAIClient = new(_appConfigurations.OpenAIKey);
